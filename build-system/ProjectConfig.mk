...
CUSTOM_HAL_SUB_IMGSENSOR = gc0312_mipi_raw
...
CUSTOM_KERNEL_IMGSENSOR = gc2355_mipi_raw gc0312_mipi_raw
...
CUSTOM_KERNEL_MAIN_IMGSENSOR = gc2355_mipi_raw
...
MTK_BQ24297_SUPPORT = yes
MTK_BQ27541_SUPPORT = no
MTK_BRANCH = alps-mp-l1.mp13.tc6sp
...
MTK_BT_SUPPORT = yes
MTK_BUILD_VERNO = alps-mp-l1.mp13.tc6sp
MTK_BWC_SUPPORT = yes
...
MTK_BATTERY_LIFETIME_DATA_SUPPORT = yes
...
MTK_PMIC_MT6397 = no
MTK_DA9212_SUPPORT = no
MTK_MT6311_SUPPORT = yes
...
MTK_RELEASE_PACKAGE = rel_customer_basic rel_customer_platform_mt8173 rel_customer_tablet rel_customer_tee_api
...
MTK_SEC_WFD_VIDEO_PATH_SUPPORT = yes
...
MTK_DISPLAYPORT_SUPPORT =

MTK_UIPQ_SUPPORT = no

BOARD_UFBL_PROJECT = suez

TARGET_MDUMP_COMPRESS = yes

TARGET_PREBUILT_TEE = vendor/amazon/signed-images/$(MTK_PROJECT)/$(TARGET_BUILD_VARIANT)/tz.img
TARGET_PREBUILT_LK = vendor/amazon/signed-images/$(MTK_PROJECT)/$(TARGET_BUILD_VARIANT)/lk.bin
TARGET_PREBUILT_PRELOADER = vendor/amazon/signed-images/$(MTK_PROJECT)/$(TARGET_BUILD_VARIANT)/preloader.bin
